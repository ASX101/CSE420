...
#line 667 "21301634.y"
    {
			...
			(yyval)->settype((yyvsp[(1) - (1)])->gettype());
	   }
    break;
...
#line 675 "21301634.y"
    {
			...
			(yyval)->settype((yyvsp[(1) - (3)])->gettype());
			
			if((yyvsp[(1) - (3)])->gettype() == "void" || (yyvsp[(3) - (3)])->gettype() == "void") 
			{
			...
			else if((yyvsp[(1) - (3)])->gettype() == "int" && (yyvsp[(3) - (3)])->gettype() == "float") 
			{
			...
			if((yyvsp[(1) - (3)])->gettype() == "error" || (yyvsp[(3) - (3)])->gettype() == "error") 
			{
				(yyval)->settype("error");
			}
...
int main(int argc, char *argv[])
{
	...
	outerror.open("error1.txt", ios::trunc);
