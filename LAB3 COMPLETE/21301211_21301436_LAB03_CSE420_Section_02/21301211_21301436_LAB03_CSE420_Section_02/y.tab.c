...
{
       0,    75,    75,    84,    93,   103,   112,   123,   122,   173,
     172,   201,   215,   230,   244,   260,   259,   293,   292,   311,
     329,   338,   347,   358,   381,   404,   425,   448,   457,   468,
     477,   486,   495,   504,   514,   524,   535,   545,   560,   570,
     579,   589,   611,   666,   674,   709,   718,   731,   740,   756,
     765,   784,   793,   824,   834,   844,   854,   863,   877,   887,
     897,   907,   916,   926,   936,   945,   954
};
#endif
...
#line 113 "21301211+21301436.y"
  ...
  case 7:
/* Line 1792 of yacc.c  */
#line 123 "21301211+21301436.y"
    {
	// Insert function into symbol table before parsing the compound statement
	currentFunction=(yyvsp[(2) - (5)])->getname();
	symbol_info* t = table->lookup((yyvsp[(2) - (5)]));
	if(t == NULL){
		...
		symbol_info* temp = table->lookup((yyvsp[(2) - (5)]));
        ...
        vector<pair<string, string>> v = temp->get_parameters();
        	...
        	if ((yyvsp[(1) - (5)])->getname() != temp->get_return_type()) {
...
#line 159 "21301211+21301436.y"
	...
	(yyval) = new symbol_info(
		(yyvsp[(1) - (7)])->getname() + " " + (yyvsp[(2) - (7)])->getname() + "(" + (yyvsp[(4) - (7)])->getname() + ")\n" + (yyvsp[(7) - (7)])->getname(),
		"func_def");
  ...
  case 9:
/* Line 1792 of yacc.c  */
#line 173 "21301211+21301436.y"
    {
	// Insert function with no parameters
	currentFunction=(yyvsp[(2) - (4)])->getname();
	if (!is_function_declared((yyvsp[(2) - (4)])->getname()))
	{
		...
		symbol_info* temp = table->lookup((yyvsp[(2) - (4)]));
				if(temp->gettype() != "func"){
					yyerror("Multiple declaration of function "+currentFunction);
				}
	}
...
#line 191 "21301211+21301436.y"
	...
	(yyval) = new symbol_info(
		(yyvsp[(1) - (6)])->getname() + " " + (yyvsp[(2) - (6)])->getname() + "()\n" + (yyvsp[(6) - (6)])->getname(),
		"func_def");
}
    break;
  ...
  case 11:
/* Line 1792 of yacc.c  */
#line 202 "21301211+21301436.y"
    {
	outlog << "At line no: " << lines << " parameter_list : parameter_list COMMA type_specifier ID " << endl
		   << endl;
	outlog << (yyvsp[(1) - (4)])->getname() << "," << (yyvsp[(3) - (4)])->getname() << " " << (yyvsp[(4) - (4)])->getname() << endl
		   << endl;
...
#line 359 "21301211+21301436.y"
	...
	if (is_variable_declared_current_scope((yyvsp[(3) - (3)])->getname()))
	{
		...
		yyerror("Multiple declaration of variable "+(yyvsp[(3) - (3)])->getname());
	}
	else
	{
...
#line 382 "21301211+21301436.y"
	...
	{
		yyerror("Multiple declaration of variable "+(yyvsp[(3) - (6)])->getname());
...
#line 405 "21301211+21301436.y"
	...
	{
		yyerror("Multiple declaration of variable "+(yyvsp[(1) - (1)])->getname());
	}
	else
	{
		// Create and insert new variable
  ...
  case 26:
/* Line 1792 of yacc.c  */
#line 426 "21301211+21301436.y"
    {
	outlog << "At line no: " << lines << " declaration_list : ID LTHIRD CONST_INT RTHIRD " << endl
		   << endl;
	outlog << (yyvsp[(1) - (4)])->getname() << "[" << (yyvsp[(3) - (4)])->getname() << "]" << endl
		   << endl;
	...
	{
		yyerror("Multiple declaration of variable "+(yyvsp[(1) - (4)])->getname());
	}
	else
	{
		// Create and insert new array
...
#line 536 "21301211+21301436.y"
  ...
  case 37:
/* Line 1792 of yacc.c  */
#line 546 "21301211+21301436.y"
    {
	outlog << "At line no: " << lines << " statement : PRINTLN LPAREN ID RPAREN SEMICOLON " << endl
		   << endl;
	outlog << "printf(" << (yyvsp[(3) - (5)])->getname() << ");" << endl
		   << endl;

	(yyval) = new symbol_info("printf(" + (yyvsp[(3) - (5)])->getname() + ");", "stmnt");
	
	symbol_info* t = table->lookup((yyvsp[(3) - (5)]));
	if(t == NULL){
		yyerror("Undeclared variable: "+(yyvsp[(3) - (5)])->getname());
		}	
...
#line 580 "21301211+21301436.y"
  ...
  case 41:
/* Line 1792 of yacc.c  */
#line 590 "21301211+21301436.y"
    {
	outlog << "At line no: " << lines << " variable : ID " << endl
		   << endl;
	outlog << (yyvsp[(1) - (1)])->getname() << endl
		   << endl;
	symbol_info* t = table->lookup((yyvsp[(1) - (1)]));
	if(t == NULL){
				yyerror("Undeclared variable: "+(yyvsp[(1) - (1)])->getname());
				(yyval) = new symbol_info((yyvsp[(1) - (1)])->getname(), "varbl");
				}
	else{
		if(t->get_is_array() == true){
			yyerror("variable is of array type : "+(yyvsp[(1) - (1)])->getname());
			(yyval) = new symbol_info((yyvsp[(1) - (1)])->getname(), "array");
  ...
  case 42:
/* Line 1792 of yacc.c  */
#line 612 "21301211+21301436.y"
    {
	outlog << "At line no: " << lines << " variable : ID LTHIRD expression RTHIRD " << endl
		   << endl;
	outlog << (yyvsp[(1) - (4)])->getname() << "[" << (yyvsp[(3) - (4)])->getname() << "]" << endl
		   << endl;
	symbol_info* t = table->lookup((yyvsp[(1) - (4)]));
	if(t == NULL){
				yyerror("Undeclared function: "+(yyvsp[(1) - (4)])->getname());
				(yyval) = new symbol_info((yyvsp[(1) - (4)])->getname() + "[" + (yyvsp[(3) - (4)])->getname() + "]", "array");
				}
	else{
			
		if(t->get_is_array()==false){
			yyerror("variable is not of array type : "+(yyvsp[(1) - (4)])->getname());
		}
		if(t->get_data_type()=="FLOAT"){
				yyerror("array index is not of integer type : "+(yyvsp[(1) - (4)])->getname());	
		}
...
#line 710 "21301211+21301436.y"
  ...
  case 46:
/* Line 1792 of yacc.c  */
#line 719 "21301211+21301436.y"
    {
	outlog << "At line no: " << lines << " logic_expression : rel_expression LOGICOP rel_expression " << endl
		   << endl;
	outlog << (yyvsp[(1) - (3)])->getname() << (yyvsp[(2) - (3)])->getname() << (yyvsp[(3) - (3)])->getname() << endl
		   << endl;
